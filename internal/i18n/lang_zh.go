...
flatten 选项:
  ...
  └── logs/            # 构建日志`,
	...
	"maintain.step1":          "[Maintain] 步骤 1/4: 清理多余软件包...",
	"maintain.step2":          "[Maintain] 步骤 2/4: 同步官方仓库软件包...",
	"maintain.step2.skip":     "[Maintain] 步骤 2/4: 无官方仓库包需要安装",
	"maintain.step3":          "[Maintain] 步骤 3/4: 同步 AUR 软件包...",
	"maintain.step3.skip":     "[Maintain] 步骤 3/4: 无 AUR 包需要安装",
	"maintain.paru.warn":      "[Maintain] 警告: paru 安装失败: %v",
	"maintain.step4":          "[Maintain] 步骤 4/4: 启用 systemd 服务...",
	"maintain.step4.skip":     "[Maintain] 步骤 4/4: 无服务需要启用",
